...
export class ControlVehiculoService {
  ...
  getControlVehiculo() {
    return this.http.get('http://54.164.205.82:3000/control');
  }

  getCtrlPlaca (placa: string) {
    return this.http.get(`http://54.164.205.82:3000/control/placa/${placa}`)
  }
  ...
  postControlVehiculo(controlVehiculoRegister: ControlVehiculoModel) {
    ...
    return this.http.post('http://54.164.205.82:3000/control', controlVehiculoRegister)
  ...
  updateNetoTotalVehiculo(idVehiculo: string, netoTotal: number) {
    ...
    return this.http.put('http://54.164.205.82:3000/vehiculo/netos/' + idVehiculo, sumaNetos)
    // return this.http.post('http://54.164.205.82:3000/control', controlVehiculoRegister)
  }
}
